...
<form action="update-hotel-name" method="post" name="hotel_form">  
  <div class="container">  
...
<input type="text" name="hotelname" placeholder="Hotel Name" size="15" required />   <br><br>

    <button type="submit" class="updatebtn">Update Name</button>    
</form>  
</body>
</html>