...
<form action="update-number-of-rooms.html" method="post" name="hotel_form">  
  <div class="container">  
...
<input type="text" name="room" placeholder="Number of Rooms" size="15" required />   <br><br>

    <button type="submit" class="updatebtn">Update Number of Rooms</button>    
</form>  
</body>
</html>