...
<form action="update-hotel-place.html" method="post" name="hotel_form">  
  <div class="container">  
...
<input type="text" name="hotelplace" placeholder="Hotel Place" size="15" required />   <br><br>

    <button type="submit" class="updatebtn">Update Place</button>    
</form>  
</body>
</html>